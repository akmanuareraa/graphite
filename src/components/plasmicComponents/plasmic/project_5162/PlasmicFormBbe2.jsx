...
import sty from "./PlasmicFormBbe2.module.css"; // plasmic-import: M_3KOK53V1n/css

export const PlasmicFormBbe2__VariantProps = new Array();

export const PlasmicFormBbe2__ArgProps = new Array(
  "applicationNo",
  "txnNo",
  "receiptNo",
  "paymentDate",
...
function PlasmicFormBbe2__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      >
        {false ? (
          <div className={classNames(projectcss.all, sty.freeBox__ubKkj)}>
            {true ? (
              <Walletstatus
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicFormBbe2__ArgProps,
      internalVariantPropNames: PlasmicFormBbe2__VariantProps
    });

    return PlasmicFormBbe2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicFormBbe2";
  } else {
    func.displayName = `PlasmicFormBbe2.${nodeName}`;
  }
  return func;
}

export const PlasmicFormBbe2 = Object.assign(
  // Top-level PlasmicFormBbe2 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicFormBbe2
    internalVariantProps: PlasmicFormBbe2__VariantProps,
    internalArgProps: PlasmicFormBbe2__ArgProps
  }
);

export default PlasmicFormBbe2;
/* prettier-ignore-end */
