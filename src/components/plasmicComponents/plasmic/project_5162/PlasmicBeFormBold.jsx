...
import sty from "./PlasmicBeFormBold.module.css"; // plasmic-import: q50-pcd5Qb2/css

export const PlasmicBeFormBold__VariantProps = new Array("versiontwo");

export const PlasmicBeFormBold__ArgProps = new Array(
  "applicationNo",
  "txnNo",
  "receiptNo",
  "paymentDate",
...
function PlasmicBeFormBold__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicBeFormBold__ArgProps,
      internalVariantPropNames: PlasmicBeFormBold__VariantProps
    });

    return PlasmicBeFormBold__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicBeFormBold";
  } else {
    func.displayName = `PlasmicBeFormBold.${nodeName}`;
  }
  return func;
}

export const PlasmicBeFormBold = Object.assign(
  // Top-level PlasmicBeFormBold renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicBeFormBold
    internalVariantProps: PlasmicBeFormBold__VariantProps,
    internalArgProps: PlasmicBeFormBold__ArgProps
  }
);

export default PlasmicBeFormBold;
/* prettier-ignore-end */
